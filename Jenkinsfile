pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/careyjr'                                                 // <------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/Miamioh-Careyjr/225-lab3-2.git'                   // <------change this
        KUBECONFIG = credentials('careyjr-225')                                             // <------change this
    }
